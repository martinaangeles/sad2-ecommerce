...
const ProductPage = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          // Assuming addProduct is a function that adds the product to the cart
  ...
  const showSizeGuide = () => {
    Swal.fire({
      imageUrl: neckGuide, // Assuming neckGuide is a variable holding the image URL
      imageHeight: 500,
          ...
          <ProductCardContainerRight>
            ...
            <ProductsGrid>
              ...
              <GuideDisplay>
                ...
                <SizeGuideButton type="button" id="sizeGuideButton" onClick={showSizeGuide}>
                  SIZE GUIDE
                </SizeGuideButton>
