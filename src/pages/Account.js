            ...
            <ContentWrapper>
              ...
              {editMode ? (
                <div>
                  ...
                  <SaveButton primary block onClick={handleSave}>Save Changes</SaveButton>
                </div>
              ) : (
                <>
                  <ContentWrapper>
                  ...
                  {userData.customerRewardDetails ? (
                    ...
                    <RewardsContainerBox>
                      ...
                      {userData.customerRewardDetails.customer_reward_code}
                        ...
                        <SaveButton primary block onClick={() => copyText(userData.customerRewardDetails.customer_reward_code)}>Copy to clipboard</SaveButton>
                        </RewardsContainerBox>
