    ...
    <BrowserRouter>
      ...
      <CartContextProvider>
        ...
        <Routes>
          ...
          <Route path="/cart" element={<AnimatedRoute element={<CartPage />} />} />
          <Route path="/checkout" element={<AnimatedRoute element={<CheckoutPage />} />} />
          <Route path="/thankyou" element={<AnimatedRoute element={<Thankyou />} />} />
          <Route path="/shop" element={<AnimatedRoute element={<ProductsPage />} />} />
          ...
          <Route path="/logout" element={<AnimatedRoute element={<LoginPage />} />} />
          <Route path="/register" element={<AnimatedRoute element={<RegisterPage />} />} />
          <Route path="/account" element={<AnimatedRoute element={<AccountPage />} />} />
          <Route path="/myorders" element={<AnimatedRoute element={<MyOrders />} />} />
        </Routes>
